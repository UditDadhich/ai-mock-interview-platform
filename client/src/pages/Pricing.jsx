...
function Pricing() {
  ...
  const handlePlan = async (plan) => {
    try {
      ...
      const amount = plan.id.toLowerCase() === "basic" ? 100 : plan.id.toLowerCase() === "pro" ? 500 : 0;
        ...
        {plans.map((plan) => {
          ...
          return (
            ...
            >
              ...
              {plan.badge && (
                <div
                  className="absoulte top-6 right-6 bg-emerald-600
              ...
              {plan.default && (
                <div
                  className="absoulte top-6 right-6 bg-gray-200
