      ...
      <div className="flex-1 px-6 py-20">
        ...
        <div className="text-center mb-28">
          ...
          <motion.p
            ...
            className="text-gray-500 mt-6 mmax-w-2xl mx-auto text-lg"
          >
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-10 mb-28">
          {[
            ...
            >
              <div
                className="abosulte -top-8 left-1/2 -translate-x-1/2 bg-white border-2 border-green-500
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {[
              ...
              },
              {
                ...
                desc: "Project-specified questions based on uploaded.",
              },
              {
                image: pdfImg,
                icon: <BsFileEarmarkText size={20} />,
              ...
              <motion.div
                ...
                className="bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl
                                    transition-all"
              >
                <div className="flex flex-col md:flex-row items-center gap-8">
                  ...
                  <div className="w-full md:w-1/2">
                    <div
                      className="bg-green-50 text-green-600 w-12 h-1
            ...
            {[
              ...
              <motion.div
                ...
                <div className="flex items-center justify-between gap-6">
                 <div className="w-1/2">
                   <h3 className="font-semibold text-sl mb-3">
                    {mode.title}
                   </h3>
