  ...
  const downloadPDF = () => {
    ...
    doc.text(
      ...
      if(finalScore >= 8){
        ...
        advice = 
         "Good foundation shown. Improve clarity and structure. Practice delivering concise, confident annswers with stronger supporting examples";
      }else{
        advice = 
         "Significant improvement required. Focus on structured thinking clarity and confidence delivery. Practice answering aloud regularly."
      }
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8">
      ...
      >
        ...
        py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap"
        >
          Download PDF
        </button>
      </div>
